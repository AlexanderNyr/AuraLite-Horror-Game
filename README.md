...
- Локализация через внешние `.lang` файлы: English, Русский, Espanol. Переключение — `F2`, выбор в меню — `1/2/3`.
- Добавлено главное меню с выбором языка и подсказками управления.
- Графика улучшена в сторону реалистичного horror-look: filmic tonemapping, height fog, animated fog noise, richer procedural materials.
...
| Фонарь | F | LIGHT |
| Сменить язык | F2 или 1/2/3 в меню | — |
